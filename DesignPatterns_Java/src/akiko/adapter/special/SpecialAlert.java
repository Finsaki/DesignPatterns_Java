...
/**
 * Handles alert testing by reading alerts from file and adding some stars around it, before printing them out.
 * Prints a bit faster than normal alert.
 * 
 * @author akiko
 *
 */
public class SpecialAlert implements IAdvancedAlert{
